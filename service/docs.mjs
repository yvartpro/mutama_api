export const docsHtml = (endpoints, appUrl) => {
    // Ensure appUrl has a default value and proper formatting
    ...
    <div class="container">
        ...
        <main>
            <div class="dashboard-card">
                ...
                <a href="${url}/api/dashboard" target="_blank" class="dashboard-link">
                    Open Dashboard
                ...
                <div class="section">
                    ...
                    ${group.map(e => `
                        <div class="endpoint">
                            ...
                            <a href="${url}/${e.path}" target="_blank" class="path">${e.path}</a>
